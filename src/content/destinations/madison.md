...
heroVideo: ""
heroImage: ""
tagline: "Lakes, curds, and radical charm"
region: great-lakes
...
budgetPerDay:
  ...
  midRange: 130
  luxury: 320
gettingThere: "Dane County Regional Airport (MSN) has nonstop service from major hubs, or drive 2.5 hours from Chicago or 75 minutes from Milwaukee on I-94/I-90."
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "MSN airport 15 min from downtown; I-90/I-94 access; Van Galder bus from Chicago"
  - icon: "🚲"
    label: "Getting Around"
    value: "One of America's most bikeable cities; BCycle bikeshare; Metro Transit buses"
  - icon: "💰"
    label: "Budget Tip"
    value: "Chazen Museum of Art on campus is free and legitimately excellent"
  - icon: "🧀"
    label: "Must Eat"
    value: "Cheese curds at The Old Fashioned — squeaky, fresh, fried to golden perfection"
  - icon: "🏨"
    label: "Where to Base"
    value: "Capitol Square for central access; Williamson St (Willy St) for local flavor"
  - icon: "🔗"
    label: "Connections"
    value: "Milwaukee is 75 min east; Spring Green (Frank Lloyd Wright's Taliesin) is 45 min west"
highlights:
  - title: "Dane County Farmers Market"
    icon: "🧀"
  - title: "State Street & Capitol Square"
    icon: "🏛️"
  - title: "Lake Mendota & Monona"
    icon: "🛶"
  - title: "University of Wisconsin Campus"
    icon: "🎓"
  - title: "Willy Street Neighborhood"
    icon: "🌈"
