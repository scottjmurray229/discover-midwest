...
budgetPerDay:
  ...
  midRange: 130
  luxury: 350
gettingThere: "Detroit Metro Airport (DTW) is a Delta hub with nonstop flights from most major US cities, or drive in via I-75, I-94, or I-96."
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "DTW airport, 25 min from downtown; Amtrak Wolverine line from Chicago"
  - icon: "🚌"
    label: "Getting Around"
    value: "QLine streetcar along Woodward Ave; DDOT buses; rideshare is cheap"
  - icon: "💰"
    label: "Budget Tip"
    value: "The DIA is pay-what-you-wish for tri-county residents; free on Fridays"
  - icon: "🍽️"
    label: "Must Eat"
    value: "Coney dogs at Lafayette Coney Island — skip American, the locals know"
  - icon: "🏨"
    label: "Where to Base"
    value: "Corktown for walkability and nightlife; Midtown for museums and culture"
  - icon: "🔗"
    label: "Connections"
    value: "Windsor, Ontario is a 5-minute tunnel ride — bring your passport"
highlights:
  - title: "Motown Museum"
    icon: "🎵"
  - title: "Diego Rivera Murals at the DIA"
    icon: "🎨"
  - title: "Eastern Market Saturday"
    icon: "🧅"
  - title: "Corktown Food & Drink"
    icon: "🍸"
