...
const AUTH_USER = process.env.AUTH_USER || 'discovermidwest';
...
<title>Translation Review — Login | Discover Midwest</title>
<style>
...
<div class="splash">
  ...
  <p class="splash-subtitle">Discover Midwest &mdash; Tagalog Translation System</p>
  ...
  <p class="footer-note">Discover Midwest Translation System &copy; 2026</p>
</div>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Translation Review — Discover Midwest</title>
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
