...
heroVideo: ""
heroImage: ""
tagline: "Rock, roll, and revelation"
region: great-lakes
...
budgetPerDay:
  ...
  midRange: 130
  luxury: 350
gettingThere: "Cleveland Hopkins International Airport (CLE) has direct flights from most US hubs, with a 25-minute RTA Red Line train straight to downtown."
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "CLE airport with RTA rail link; Amtrak Lake Shore Limited; I-90/I-71 interchange"
  - icon: "🚃"
    label: "Getting Around"
    value: "RTA Red Line rail, HealthLine BRT on Euclid Ave; walkable downtown core"
  - icon: "💰"
    label: "Budget Tip"
    value: "Cleveland Museum of Art is completely free — one of the best free museums in the world"
  - icon: "🍽️"
    label: "Must Eat"
    value: "Pierogies at Sokolowski's University Inn — open since 1923, cash-only cafeteria line"
  - icon: "🏨"
    label: "Where to Base"
    value: "Ohio City for food and walkability; Tremont for a quieter, artsy neighborhood feel"
  - icon: "🔗"
    label: "Connections"
    value: "Cedar Point is 60 miles west; Cuyahoga Valley National Park is 30 minutes south"
highlights:
  ...
  - title: "West Side Market"
    icon: "🥩"
  - title: "Tremont Art Walks"
    icon: "🎨"
  - title: "Lake Erie Waterfront"
    icon: "🌊"
