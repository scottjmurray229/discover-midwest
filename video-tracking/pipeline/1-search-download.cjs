...
async function downloadSelected(entry, video) {
  ...
  // Skip youtube/raw copy to save disk space (HDD nearly full)
  // Raw clip stays in raw-downloads/ for batch-process (step 2)
  // Step 2 will delete raw files after compression
  console.log(`  Raw file kept in raw-downloads/ (youtube/raw copy skipped to save space)`);
