...
def add_footer(canvas, doc):
    ...
    canvas.drawCentredString(
        ...
        f"DiscoverMidwest.info  \u2022  Midwest Travel Guide  \u2022  Page {doc.page}"
    )
    canvas.restoreState()
...
def build_pdf():
    ...
    closing.append(Paragraph(
        "Visit DiscoverMidwest.info for interactive maps, more destination guides, and our AI trip planner.",
        styles["CoverSubtitle"]
    ))
    closing.append(Spacer(1, 6))
    closing.append(Paragraph(
        "More Guides: Chicago \u2022 Kansas City \u2022 Minneapolis \u2022 Detroit \u2022 Milwaukee \u2022 and 8 more destinations",
        styles["CoverSubtitle"]
    ))
    ...
    story.append(Paragraph(
        "This guide was created by Scott for DiscoverMidwest.info",
        styles["Caption"]
    ))
    story.append(Paragraph(
    ...
    story.append(Paragraph(
        "\u00a9 2026 Discover Midwest. All rights reserved. No spam, unsubscribe anytime.",
        styles["Footer"]
    ))
