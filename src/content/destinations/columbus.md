...
budgetPerDay:
  ...
  midRange: 120
  luxury: 300
gettingThere: "John Glenn Columbus International Airport (CMH) is 10 minutes east of downtown, with nonstop service from most major US cities."
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "CMH airport 10 min from downtown; I-70 and I-71 crossroads; no Amtrak service"
  - icon: "🚌"
    label: "Getting Around"
    value: "COTA buses and CMAX BRT; very bikeable; rideshare is cheap and fast"
  - icon: "💰"
    label: "Budget Tip"
    value: "First Thursdays in the Short North — galleries open late with free admission"
  - icon: "🍽️"
    label: "Must Eat"
    value: "Thurman's Cafe for a burger that will ruin all other burgers for you"
  - icon: "🏨"
    label: "Where to Base"
    value: "Short North for walkability and nightlife; German Village for charm and quiet"
  - icon: "🔗"
    label: "Connections"
    value: "Hocking Hills is 60 miles southeast for world-class Midwest hiking"
highlights:
  - title: "Short North Arts District"
    icon: "🎨"
  - title: "German Village"
    icon: "🏘️"
  - title: "North Market"
    icon: "🧆"
  - title: "Scioto Mile Riverfront"
    icon: "🌳"
  - title: "Ohio State Campus & Football"
    icon: "🏈"
