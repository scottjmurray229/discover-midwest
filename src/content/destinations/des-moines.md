...
heroVideo: ""
heroImage: ""
heroAlt: "State Capitol gold dome and Pappajohn Sculpture Park, Des Moines, Iowa"
...
budgetPerDay:
  ...
  midRange: 110
  luxury: 280
gettingThere: "Des Moines International Airport (DSM) is 15 minutes from downtown, with nonstop service from most US hubs including Chicago, Denver, Dallas, and Atlanta."
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "DSM airport 15 min from downtown; I-80 and I-35 crossroads; no passenger rail"
  - icon: "🚗"
    label: "Getting Around"
    value: "Downtown and East Village walkable; DART buses; car helpful for outer neighborhoods"
  - icon: "💰"
    label: "Budget Tip"
    value: "Pappajohn Sculpture Park and Capitol building tours are completely free"
  - icon: "🍔"
    label: "Must Eat"
    value: "A loose meat sandwich at Tastee Inn & Out — an Iowa original since 1955"
  - icon: "🏨"
    label: "Where to Base"
    value: "East Village for walkability and restaurants; Downtown for convention access"
  - icon: "🔗"
    label: "Connections"
    value: "Omaha is 2.5 hours west; Iowa City is 2 hours east; Kansas City is 3 hours south"
highlights:
  - title: "Pappajohn Sculpture Park"
    icon: "🗿"
  - title: "East Village District"
    icon: "🏙️"
  - title: "Downtown Farmers Market"
    icon: "🌽"
  - title: "Iowa State Capitol"
    icon: "🏛️"
  - title: "Zombie Burger + Shake Lab"
    icon: "🍔"
